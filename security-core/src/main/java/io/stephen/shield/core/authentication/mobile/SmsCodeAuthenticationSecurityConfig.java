...
public class SmsCodeAuthenticationSecurityConfig extends SecurityConfigurerAdapter<DefaultSecurityFilterChain, HttpSecurity> {
	...
	public void configure(HttpSecurity http) {
		...
		smsCodeAuthenticationFilter.setAuthenticationSuccessHandler(shieldAuthenticationSuccessHandler);
		smsCodeAuthenticationFilter.setAuthenticationFailureHandler(shieldAuthenticationFailureHandler);
